...
vector<double> testInputvsResults(const vector<double> &t1)
{
...
void testSingleRun(vector<double> &data)
{
	assert(data.size()%2);
	unsigned int fitParam = data.size() - (data.size()/2);
	vector<double> startingFit = vector<double>(fitParam,0.0);
...
void runTests(int argc, char** argv) 
{
	...
	vector<double> temp = testInputvsResults({11-3.31/2, 12+3.46/4, 11-3.31/2, 10+3.16/3, 10-3.16/1, 10-3.16/2, 10+3.16/3, 10+3.16/2, 10-3.16/1, 10+3.16/2, 11-3.31/1, 12-3.46/2, 11-3.31/3});
	assert(temp.size() == 13);
