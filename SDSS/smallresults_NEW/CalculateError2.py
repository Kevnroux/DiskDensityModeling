...
def calc_error(data, actual, chi_sq):
    ...
    #print("FINAL")
    #print(final)
    ret = [0] + [(abs(final[i][i]))**.5 for i in range(0, len(final))]
    return ret
